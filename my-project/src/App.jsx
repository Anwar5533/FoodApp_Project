...
function ItemCard(props) {
  ...
  return (
      <div class="w-[220px] m-[10px] border-2 cursor-pointer hover:bg-slate-100 hover:border-slate-100">
          <div className=" ">
          <img className="w-[200px] pl-[5px] m-[5px]" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.cloudinaryImageId} alt="" />
          </div>
          <div>
          <h3>{resData.name}</h3>
...
const resObj= [
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-08-22 22:00:00",
        "opened": true
      },
      "badges": {
    ...
    "analytics": {
      "context": "seo-data-8156a9f8-5d15-487a-bafb-466f2de477d2"
    },
    "cta": {
